...
var file_pkg_server_service_proto_rawDesc = []byte{
	...
	0x52, 0x41, 0x50, 0x48, 0x45, 0x52, 0x10, 0x07, 0x32, 0x96, 0x03, 0x0a, 0x0f, 0x4d, 0x61, 0x6e,
...
var file_pkg_server_service_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
...
var file_pkg_server_service_proto_depIdxs = []int32{
	...
	22, // 16: manifest.ManifestService.StreamUpdates:input_type -> google.protobuf.Empty
	...
	14, // 21: manifest.ManifestService.StreamUpdates:output_type -> manifest.ManifestUpdate
	16, // 22: manifest.ManifestService.SignInWithApple:output_type -> manifest.SignInResponse
	18, // 23: manifest.ManifestService.SignOut:output_type -> manifest.SignOutResponse
	16, // 24: manifest.ManifestService.VerifySessionID:output_type -> manifest.SignInResponse
	21, // 25: manifest.ManifestService.ToggleFuelRequested:output_type -> manifest.ToggleFuelRequestedResponse
